          ...
          <div className="p-4 bg-zinc-700 rounded flex justify-between" key={index} >
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col gap-0 justify-items-center">
                ...
                <span className="text-xs text-zinc-400 leading-tight">{level.count} Kanji</span>
              </div>
            </div>
            <Link href={`/level/${level.level}`} className="flex items-center bg-zinc-600 px-3 rounded hover:bg-zinc-500">Begin</Link>
          </div>
          )}
        </div>
      </div>
