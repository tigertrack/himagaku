  ...
  const MenuSkeleton = () => (
    <div className="sm:flex gap-5 hidden">
      <div
        ...
        className="bg-sky-600 hover:cursor-pointer px-3 py-1 rounded-xl animate-pulse h-8 w-20"
      ></div>
      <div
        onClick={handleSignOut}
        className="bg-sky-600 hover:cursor-pointer px-3 py-1 rounded-xl animate-pulse h-8 w-20"
    ...
    <nav className="flex justify-between items-cente bg-sky-700 p-4">
      ...
      {isLoading ? (
        ...
        <div className="sm:flex gap-1 hidden">
          <Link
            href="/search"
            className="hover:bg-sky-600 hover:cursor-pointer px-3 py-1 rounded"
          >
            Search
          </Link>
          <Link
