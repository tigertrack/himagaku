...
const TopNav = ({toggleSidebar}: Props) => {
  ...
  return (
    <nav className='flex justify-between items-cente bg-sky-950 p-4'>
      ...
      <div className="sm:flex gap-1 hidden">
        ...
        <Link href="/quiz" className="hover:bg-sky-600 hover:cursor-pointer px-3 py-1 rounded">Quizes</Link>
